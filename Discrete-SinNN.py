...
def custom_loss(y_pred, y_true):
    return torch.mean((y_true - y_pred) ** 2) + torch.randn(1) * 0.08
...
with open('final_Bweights.txt', 'w') as file:
...
plt.ylabel('DSinNN Loss', fontsize=46, path_effects=[patheffects.withStroke(linewidth=1.25, foreground='black')])
...
plt.savefig("DSinNN_Loss_Epoch.png", dpi=400, bbox_inches='tight')
