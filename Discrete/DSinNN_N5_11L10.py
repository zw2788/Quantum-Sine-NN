...
for num_neuron in range(5, 12):  # 2, 3, ..., 7, for paper range(2,12)
...
with open('proportions_layerN8L10.txt', 'w') as f:
...
with open('all_train_test_lossN8L10.csv', 'w', newline='') as csvfile:
